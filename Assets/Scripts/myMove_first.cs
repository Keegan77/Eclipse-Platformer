...
public class myMove_first : MonoBehaviour
{
   ...
   // public static event nightTime timeChangeNight;
    ...
    public stateChangeEffect myStateChanger;
    ...
    void Start()
    {
        ...
        //myStateChanger = gameObject.GetComponent<stateChangeEffect>();
